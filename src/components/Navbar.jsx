...
function Navbar({ darkMode, setDarkMode }) {
  ...
  <div className="max-w-5xl mx-auto flex items-center justify-between py-4 px-3 sm:px-4">
    ...
    {/* Right Side Controls: Group Hamburger and Theme Toggle */}
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="p-2 rounded-full bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 text-indigo-600 dark:text-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
      >
